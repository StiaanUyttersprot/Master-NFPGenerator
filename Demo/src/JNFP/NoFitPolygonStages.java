...
public class NoFitPolygonStages {
	...
	public static int aantalNFPStages = 0;
	public static List<NoFitPolygon> nfpToDraw = new ArrayList<>();

	public static List<Group> nfpGroupList = new ArrayList<>();
	
	
	public static double sceneSizeX = 200;
	public static double sceneSizeY = 200;
	...
	public static Group drawNFP(NoFitPolygon nfp) {
...
//		makeNFPPolylineScene(nfpGroup, nfp, biggestValue);
		nfpGroupList.add(new Group(nfpGroup));
		return nfpGroup;
	}
...
//		Color bColor = Color.web("0xEEE8C8");
        ...
        Circle refPoint = new Circle(resizeFactor * mPolygon.getOuterPolygon()[0].getxCoord() + sceneSizeX / 2,
        		resizeFactor *mPolygon.getOuterPolygon()[0].getyCoord() + sceneSizeY / 2 , 5);
        switch(color){
        case 0:{
