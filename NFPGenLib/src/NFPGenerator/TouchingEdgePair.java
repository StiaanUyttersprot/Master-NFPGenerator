...
public class TouchingEdgePair {
	...
	protected static double angleRound = 1e-6;
	...
	protected TouchingEdgePair(Edge statEdge, Edge orbEdge, Coordinate touchPoint) {
	...
	/**
	 * @return the first edge of the touching pair
	 */
	public Edge getStatEdge() {
		return statEdge;
	}

	protected void setStatEdge(Edge statEdge) {
		this.statEdge = statEdge;
	}

	/**
	 * @return the second edge of the touching pair
	 */
	public Edge getOrbEdge() {
		return orbEdge;
	}

	protected void setOrbEdge(Edge orbEdge) {
		this.orbEdge = orbEdge;
	}

	/**
	 * @return the coordinate where the two edges touch
	 */
	public Coordinate getTouchPoint() {
		return touchPoint;
	}

	protected void setTouchPoint(Coordinate touchPoint) {
		this.touchPoint = touchPoint;
	}

	protected Vector getPotentialVector() {
	...
	protected void calcFeasibleAngleRange() {
	...
	protected boolean isFeasibleVector(Vector vector) {
	...
	public String toString() {
		return "TouchingEdgePair [statEdge=" + statEdge + ", orbEdge=" + orbEdge + ", touchPoint=" + touchPoint;
	}
